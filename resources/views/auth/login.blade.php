...
<body class="authentication-bg position-relative">
                        ...
                        <div class="card-body px-4">
                            ...
                            <div class="text-center w-75 m-auto mb-4">
                                <a href="{{ route('any', 'index') }}ml">
                                    <span><img src="/images/logo.svg" alt="logo" height="44"></span>
                                </a>
                            </div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-3">
                                    {{-- <a href="{{ route('any', ['recoverpw']) }}" class="text-muted float-end fs-12">Forgot your password?</a> --}}
    ...
    <footer class="footer footer-alt fw-medium">
        <span class="bg-body">
            ...
            </script> © KZS Style - Powered by <a href="https://iciclecorporation.com/">ICICLE Corporation</a>
        </span>
    </footer>
