            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('allVariation') }}">Variations</a></li>
                    ...
                    <form action="" class="needs-validation" method="POST" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2 col-lg-4">
                                ...
                                <input type="text" class="form-control" id="value" placeholder="Enter Attribute value" name="value">
                            </div>
                            <div class="mb-2 col-lg-4">
                                <label class="form-label" for="slug">
                                    Meta
                                </label>
                                <input type="text" class="form-control" id="meta" placeholder="Enter Attribute meta" name="meta">
                            </div>
